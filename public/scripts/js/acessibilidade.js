...
const configuration = new hatemile.util.Configure(hatemile_configuration)
// Instancia os parsers HTML e CSS, necessários para executar as correções
const htmlParser = new hatemile.util.html.vanilla.VanillaHTMLDOMParser(document)
// Instancia a classe de soluções para os problemas de acessibilidade do CSS.
const accessibleCSS = new hatemile.implementation.AccessibleCSSImplementation(htmlParser)
...
const accessibleEvent = new hatemile.implementation.AccessibleEventImplementation(htmlParser)
...
const accessibleForm = new hatemile.implementation.AccessibleFormImplementation(
  htmlParser,
  configuration
)
